                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        ...
                                        <tr style="background-color: #CEECF5;">
                                            ...
                                            <td>$ {{totalParcial=(total-totalnit).toFixed(2)}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                                            <td colspan="4" align="right"><strong>Total nit:</strong></td>
                                            <td>$ {{totalnit=((total*nit)/(1+nit)).toFixed(2)}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
                            ...
                            <div class="table-responsive col-md-12">
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        ...
                                        <tr style="background-color: #CEECF5;">
                                            <td colspan="3" align="right"><strong>Total nit:</strong></td>
                                            <td>$ {{totalnit=((total*nit)).toFixed(2)}}</td>
                                        </tr>
                                        <tr style="background-color: #CEECF5;">
    ...
    export default {
        ...
        methods : {
            ...
            validarIngreso(){
                ...
                if (!this.nit) this.errorMostrarMsjIngreso.push("Ingrese el nit de compra");
